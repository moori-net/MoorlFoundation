...
class ImageMapItemDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new IntField('quantity', 'quantity'))->addFlags(new Required(), new EditField('number')),
            (new IntField('priority', 'priority'))->addFlags(new Required(), new EditField('number')),
            (new IntField('pos_left', 'posLeft'))->addFlags(new Required(), new EditField('number')),
            (new IntField('pos_top', 'posTop'))->addFlags(new Required(), new EditField('number')),
