...
class FileExplorerController
{
    ...
    #[Route(path: '/api/moorl-foundation/file-explorer/list-contents', name: 'api.moorl-foundation.file-explorer.list-contents', methods: ['POST'])]
    ...
    public function read(Request $request, Context $context): Response
    {
        ...
        $disposition = HeaderUtils::makeDisposition(HeaderUtils::DISPOSITION_ATTACHMENT, basename((string) $path));
