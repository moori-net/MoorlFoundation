...
Shopware.Component.register('moorl-map', {
    ...
    methods: {
        ...
        markerPreview() {
            let iconOptions = {
                shadowUrl: this.item.markerShadow
                    ? this.item.markerShadow.url
                    : null,
                iconRetinaUrl: this.item.markerRetina
                    ? this.item.markerRetina.url
                    : null,
            ...
            featureMarker.push(
                L.marker(this.coord, { icon: L.icon(iconOptions) })
                    .bindPopup(
                        '<p><b>Lorem Ipsum GmbH</b><br>Musterstraße 1<br>12345 Musterstadt</p>',
                        {
                            autoPan: false,
                            autoClose: true,
                        }
