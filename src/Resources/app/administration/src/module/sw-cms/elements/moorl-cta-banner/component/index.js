...
Shopware.Component.register('sw-cms-el-moorl-cta-banner', {
    template,
    ...
    computed: {
        ...
        bannerMediaUrl() {
            ...
            if (this.element.data?.media) {
                ...
                if (
                    ...
                    this.element.config.elementType.value === 'product' &&
                    this.element.data?.product?.cover?.media
                ) {
        ...
        backgroundCss() {
            if (!this.element.config.videoActive.value) {
                return {
                    ...
                    'background-attachment': this.element.config.backgroundFixed
                        .value
                        ? 'fixed'
                        : 'initial',
        ...
        boxCss() {
            return {
                display:
                    this.element.config.iconPosition.value === 'top'
                        ? 'block'
                        : 'flex',
