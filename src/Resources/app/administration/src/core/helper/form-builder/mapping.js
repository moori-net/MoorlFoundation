const mapping = {
    ...
    salesChannel: {tab: 'relations', card: 'general'},
    customer: {tab: 'relations', card: 'general', attributes: {labelProperty: 'customerNumber'}},
    article: {tab: 'relations', card: 'general'},
    look: {tab: 'relations', card: 'general'},
    product: {tab: 'relations', card: 'general'},
    merchant: {tab: 'relations', card: 'general'},
    category: {tab: 'relations', card: 'general'},
    site: {tab: 'relations', card: 'general'},
